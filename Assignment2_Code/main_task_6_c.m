...
[x11_train,x12_train]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class1_train.txt','%f %f');
[x11_test,x12_test]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class1_test.txt','%f %f');
[x11_val,x12_val]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class1_val.txt','%f %f');

[x21_train,x22_train]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class2_train.txt','%f %f');
[x21_test,x22_test]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class2_test.txt','%f %f');
[x21_val,x22_val]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class2_val.txt','%f %f');

[x31_train,x32_train]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class3_train.txt','%f %f');
[x31_test,x32_test]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class3_test.txt','%f %f');
[x31_val,x32_val]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class3_val.txt','%f %f');

[x41_train,x42_train]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class4_train.txt','%f %f');
[x41_test,x42_test]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class4_test.txt','%f %f');
[x41_val,x42_val]=textread('C:\Users\Pranav M\Desktop\ML1\datasets\group5\overlapping\class4_val.txt','%f %f');
% 
