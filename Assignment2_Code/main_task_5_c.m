clearvars;
[x11, x12] = textread('..\data_assign2_group5\group5\overlapping\class1_train.txt','%f %f');
[xval11, xval12] = textread('..\data_assign2_group5\group5\overlapping\class1_val.txt','%f %f');
[x21, x22] = textread('..\data_assign2_group5\group5\overlapping\class2_train.txt','%f %f');
[xval21, xval22] = textread('..\data_assign2_group5\group5\overlapping\class2_val.txt','%f %f');
[x31, x32] = textread('..\data_assign2_group5\group5\overlapping\class3_train.txt','%f %f');
[xval31, xval32] = textread('..\data_assign2_group5\group5\overlapping\class3_val.txt','%f %f');
[x41, x42] = textread('..\data_assign2_group5\group5\overlapping\class4_train.txt','%f %f');
[xval41, xval42] = textread('..\data_assign2_group5\group5\overlapping\class4_val.txt','%f %f');


[xtest11, xtest12] = textread('..\data_assign2_group5\group5\overlapping\class1_test.txt','%f %f');
[Ntest1, NotRequired] = size(xtest11);
Xtest1 = [xtest11, xtest12];
[xtest21, xtest22] = textread('..\data_assign2_group5\group5\overlapping\class2_test.txt','%f %f');
[Ntest2, NotRequired] = size(xtest21);
Xtest2 = [xtest21, xtest22];
[xtest31, xtest32] = textread('..\data_assign2_group5\group5\overlapping\class3_test.txt','%f %f');
[Ntest3, NotRequired] = size(xtest31);
Xtest3 = [xtest31, xtest32];
[xtest41, xtest42] = textread('..\data_assign2_group5\group5\overlapping\class4_test.txt','%f %f');
...
for i = 1:Q4
    ...
    temp4 = points4- mu4(i, :);
    sigma4(i) = {(1/(Ni4(i)-1))*(temp4' * temp4)};
end
...
while (abs(L_new - L_old)>0.05)
    ...
    for i = 1:Q4
        ...
        sigma4(i) = { (1/Ni4(i))*((X4-mu4(i, :))' *  diag(gamma4(:, i)) * (X4-mu4(i, :))) };  
...
set(gca,'ydir','normal');
cmap = [0.7 1 0.7;0.1 0.9 1;1 0.7 1;1 0.6 0.6];
colormap(cmap);
